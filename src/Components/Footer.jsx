      ...
      <div className="row">
        ...
        <div className="col-12 col-md-6 col-lg-3 mt-5">
          <div className="foot-contact">
            <h2>Contact Us</h2>
            <ul>
              <li>Email: <br /><a href="/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="cda4a3aba2e3a9a8a8bfb9aebfa8acb9a4bba88daaa0aca4a1e3aea2a0">idahsanali@gmail.com</a></li>
